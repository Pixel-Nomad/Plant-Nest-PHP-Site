...
INSERT INTO `feedbacks` (`id`, `user_id`, `Feedback_Date`, `satisfaction`, `message`) VALUES
	...
	(2, 7, '2023-09-20 05:51:10', 'Very satisfied', 'Very Nice!');
...
-- Dumping data for table plants.orders: ~3 rows (approximately)
DELETE FROM `orders`;
INSERT INTO `orders` (`order_id`, `user_id`, `order_secret`, `OrderDate`, `Total_Amount`, `Total_Price`, `Status`) VALUES
	(1, 1, 'LA5B6zIOcV', '2023-08-12 20:06:26', 1, 590, 'On The Way'),
	(2, 2, '4r3gWL9LFe', '2023-08-12 23:51:15', 5, 62894, 'Delivered'),
	(3, 1, 'XBuw5qfQ7N', '2023-08-13 05:11:36', 1, 5900, 'Delivered'),
	(4, 7, 'mxWMyyllvK', '2023-09-20 05:50:00', 1, 5900, 'Picked UP');
...
-- Dumping data for table plants.order_items: ~7 rows (approximately)
...
INSERT INTO `plants` (`plant_id`, `name`, `description`, `price`, `quantity`, `image`, `featured`, `category_id`) VALUES
	(1, 'Sunflower', 'Sunflower plants are native to North America and are known for their large, bright yellow flowers that resemble the sun.\r\nThey belong to the family Asteraceae and are cultivated for their oil-rich seeds, which are commonly used for cooking oil, bird feed, and other purposes.', 5000, 2, 'https://s3.amazonaws.com/YouGarden/Web/500x500/560541_2.jpg', 'yes', '1'),
	(2, 'Daffodil', 'Narcissus is a genus of predominantly spring flowering perennial plants of the amaryllis family, Amaryllidaceae. Various common names including daffodil,[Note 1] narcissus and jonquil, are used to describe all or some members of the genus. Narcissus has conspicuous flowers with six petal-like tepals surmounted by a cup- or trumpet-shaped corona. The flowers are generally white and yellow (also orange or pink in garden varieties), with either uniform or contrasting coloured tepals and corona.', 5000, 7, 'https://s3.amazonaws.com/YouGarden/Web/500x500/600098_3.jpg', 'yes', '1'),
...
INSERT INTO `reviews` (`id`, `plant_id`, `user_id`, `Review_Date`, `stars`, `review`) VALUES
	...
	(2, 1, 7, '2023-09-20 05:49:20', 5, 'Awesome');
...
-- Dumping data for table plants.users: ~3 rows (approximately)
DELETE FROM `users`;
INSERT INTO `users` (`user_id`, `username`, `fullname`, `email`, `contact`, `company`, `address`, `country`, `city`, `password`, `role`, `verified`, `date`) VALUES
	(1, 'masterAccount', 'Tayyab Naseem', 'mr.tgamer247797703@gmail.com', '00000000000', 'aptech', 'address 1', 'Bahamas', 'Karachi', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'master', 'true', '2023-09-20 04:34:53'),
	(2, 'userAccount', 'Tayyab Naseem', 'mr.tgamer247797704@gmail.com', '03123456789', 'aptech', 'address 1', 'PK', 'Karachi', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'user', 'false', '2023-09-20 05:59:04'),
	(7, 'InsanoDeath', 'sameer arora', 'insanodeathgaming@gmail.com', '1234567891', 'INDIAN TRUCKERS', '123/5 Delhi', 'India', 'delhi', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'admin', 'true', '2023-09-20 05:54:27');
