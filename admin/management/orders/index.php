...
<body>
            ...
            <nav class="navbar-dark">
                ...
                <li>
                    ...
                    <ul class="navbar-nav ps-3">
                        ...
                        <li>
                        <a href='<?php echo $config['URL']?>/admin/management/orders' class="nav-link px-3 active">
                            <span class="me-2"><i class="bi bi-speedometer2"></i></span>
  ...
  <div class="review-form-overlay" id="reviewFormOverlay">
        <div class="review-form">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="options" id="Pending" value="Pending" checked>
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="options" id="On-The-Way" value="On The Way" checked>
                <label class="form-check-label" for="On-The-Way">
                    On The Way
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="options" id="Delivered" value="Delivered" checked>
                <label class="form-check-label" for="Delivered">
                    Delivered
                </label>
            </div>
            <input type="number" class="d-none" id="old-orderid" name="old-orderid" value="">
            <br>
    ...
    <script>
        ...
        button.addEventListener("click", function () {
            ...
            openReviewForm(id, status);
        });
        });

        // Function to open the review form with a predefined plant_id
        function openReviewForm(id, status) {
            document.getElementById("old-orderid").value = id;
            document.getElementById(replaceSpacesWithHyphens(status)).checked = true;
